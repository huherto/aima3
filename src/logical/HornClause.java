...
public class HornClause extends Sentence {
    ...
    public static HornClause Fact(String name) {
        return new HornClause(new Symbol(name), new True());
    }
    
    public static HornClause NegFact(String name) {
    ...
    public Set<Symbol> symbolsOnBody() {
